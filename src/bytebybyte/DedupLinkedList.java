...
public class DedupLinkedList {
    ...
    public static void main(String[] args) {
        ...
        if (l1.equals(l2)) 
            System.out.println("threads.Test with 1 duplicate passed.");
        else
            System.out.println("threads.Test with 1 duplicate failed");

        // threads.Test 2 duplicates
        Node n2 = new Node(1);
        n2.next = new Node(1);
        ...
        if (l1_2.equals(l2_2)) 
            System.out.println("threads.Test with 2 duplicates passed.");
        else
            System.out.println("threads.Test with 2 duplicates failed.");

        // threads.Test no duplicates
        Node n3 = new Node(1);
        n3.next = new Node(2);
        ...
        if (l1_3.equals(l2_3)) 
            System.out.println("threads.Test with no duplicates passed.");
        else
            System.out.println("threads.Test with no duplicates failed.");
